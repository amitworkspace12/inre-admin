    ...
    <div className='w-full h-screen flex'>
      <div className='w-[50%] h-full flex items-center justify-center font-opensans'>
        <div className='grid gap-10 w-[60%]'>
            <div>
            <p className='text-[40px] font-[700] text-[#002550] leading-[54px]'>Login</p>
            ...
            <form className='grid gap-6 w-full '>
                <div className='flex flex-col gap-1 w-full'>
                    ...
                    <input type='email' className='w-full border-[1px] border-[#1A1A1A] outline-none  rounded-[8px] h-[44px] px-2 pl-14 placeholder:text-[#1a1a1a] placeholder:font-[400] placeholder:opacity-20 border-opacity-20 ' placeholder='Enter Moblie Number'/>
