...
const EditClient = ({page, setPage,  subPage, setSubPage}) => {
      ...
      <div className="p-5 w-[100%] lg:w-[80%] grid gap-5 box-border pb-20 h-[100%]">
        ...
        <div className="flex justify-between w-[100%] flex-col gap-5 lg:gap-0 lg:flex-row">
          ...
          <div className="flex text-[12px] font-[600] font-opensans w-fit">
            <button className="bg-[#002550] text-white p-2 px-8  hover:opacity-80">
              Client Side
            </button>
            <button
              className="bg-white p-2 px-8  hover:opacity-80"
              onClick={() =>
                navigate("/servicemanagement/pre-booking/virtualsite/Pilot")
              }
            >
              Pilot Side
            </button>
