...
const EditBackgroundDetails = ({page, setPage,  subPage, setSubPage}) => {
  ...
  return (
    ...
    <div className="p-3 lg:w-[80%] w-full grid gap-5 box-border pb-20">
      ...
      <div className={'flex gap-5 bg-white p-2 h-[38px] rounded-t-[6px] font-publicsans text-[15px] font-[400] border-b-2 w-[70%]'}>
      ...
      <div className="grid grid-cols-2 w-[80%] gap-x-20  gap-10 font-opensans">
        ...
        <div className="flex flex-col w-full gap-[6px]">
          ...
          <Select initial={'dummy'} editing = {editing} options={optionsDummy} setSelectOpen={setSelectOpenCity} selectOpen={selectOpenCity} selected={selectedDummy} setSelected={setSelectedDummy}/>
        </div>
        ...
        <div className="flex flex-col w-full gap-[6px]">
          ...
          <Select initial={'dummy'} editing={editing} options={optionsDummy} setSelectOpen={setSelectOpenBuilder} selectOpen={selectOpenBuilder} selected={selectedDummy} setSelected={setSelectedDummy}/>
        </div>
...
<Select options={optionsDummy} initial={'dummy'} editing={editing} setSelectOpen={setSelectOpenProject} selectOpen={selectOpenProject} selected={selectedDummy} setSelected={setSelectedDummy}/>
...
<Select initial={'Required'} editing={editing} options={options} setSelectOpen={setSelectOpen} selectOpen={selectOpen} selected={selected} setSelected={setSelected}/>
        </div>
...
export default EditBackgroundDetails
